...
public class CmsWebServletContextListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent event) {
    try {
      ...
      String luceneProjectsDirectory = constants.getLuceneProjectsDir();
      ...
      context.setAttribute("luceneProjectsDirectory", luceneProjectsDirectory);
      ...
      LOGGER.info(CmsWebServletContextListener.class.getName() + ": contextInitialized (luceneProjectsDirectory= \"" + luceneProjectsDirectory + "\", set in constants.properties)");
